...
Every level is a 13x13 maze with 84 pacgums spread evenly over it. All
...
| Level | Size | Pacgums | Fill | Realistic time | Margin on 90 s |
|---|---|---|---|---|---|
| 1 | 13x13 | 84 | 51% | 43 s | 47 s |
| 3 | 13x13 | 84 | 51% | 47 s | 43 s |
| 9 | 13x13 | 84 | 51% | 41 s | 49 s |
| 10 | 13x13 | 84 | 51% | 44 s | 46 s |

- [x] Every level is clearable within `level_max_time`, with at least
      43 s of margin on the worst one. **This was a real defect**: with
...
- [x] 84 pacgums is the floor for VI.1's "most corridors": a 13x13 maze
      has 164 usable corridors, so fewer than 83 would cover under half
...
11. **Levels were impossible to finish.** Once pacgums filled most
    ...
    pacgums at 8 cells per second, which leaves at least 26 s of margin
    on every level.
